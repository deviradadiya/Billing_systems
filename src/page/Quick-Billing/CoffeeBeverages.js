...
const CoffeeBeverages = () => {
    ...
    const [products] = useState([
        ...
        { id: 5, name: "Cold Brew", price: "₹229", Image: ProductIcon, Icon: PlusIcon },
        { id: 6, name: "Mocha", price: "₹229", Image: ProductIcon, Icon: PlusIcon },
        { id: 7, name: "Iced Coffee", price: "₹229", Image: ProductIcon, Icon: PlusIcon },
    ]);
...
export default CoffeeBeverages;
